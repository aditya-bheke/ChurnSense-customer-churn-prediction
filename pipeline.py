...
def generate_churn_data(n_samples: int = 7500) -> pd.DataFrame:
    """
...
def train_models(X_train, y_train):
    ...
    if best_name == "XGBoost":
        ...
        print(f"\n[TRAIN] Performing Hyperparameter Tuning for {best_name}...")
        param_grid = {
        ...
        search = RandomizedSearchCV(
            ...
            param_distributions=param_grid, n_iter=15, scoring='roc_auc', cv=cv, verbose=1, n_jobs=-1, random_state=RANDOM_STATE
        )
